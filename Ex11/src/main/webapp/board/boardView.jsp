...
<body>
	<div id="wrap" align="center">
		...
		<input type="button" value="게시글 등록" onclick="location.href='BoardServlet?command=board_write_form'">
   		...
   		<!-- 댓글목록.끝. ---------------------------------------->
   		<div id="password-error" style="margin: 10px 10px; color: red; text-align:left;">
   			${message}
   		</div>
	...
	<div id="modalModify" class="modal">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button class="btn-close" onclick="closeWindow()">x</button>
				<h2>수정하시겠습니까?</h2>
			</div>
				...
				<div align="center">
					...
					<form action="BoardServlet" name="frm" method="post">
						...
						<table style="width: 80%">
							<tr>
								<th>비밀번호</th>
								<td><input id="input-password" type="password" name="pass" size="20"></td>
							</tr>
						</table>
						<br> 
			...
			<div class="modal-footer">
				<button class="btn-footer" onclick="closeWindow()">닫기</button>
			</div>
		</div>
